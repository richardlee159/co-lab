...
module cpu_top(
    ...
    assign bus_addr = EXMEM_aluout;
    assign bus_din  = ForwardB_MEM ? rfwd : EXMEM_b;
    assign dmemout  = bus_dout;
    assign bus_rd   = EXMEM_MemRead;
    assign bus_wr   = EXMEM_MemWrite;
